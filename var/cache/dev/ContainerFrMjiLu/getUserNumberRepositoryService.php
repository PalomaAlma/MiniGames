 ...
 */
class getUserNumberRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserNumberRepository' shared autowired service.
     *
     * @return \App\Repository\UserNumberRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserNumberRepository.php';

        return $container->privates['App\\Repository\\UserNumberRepository'] = new \App\Repository\UserNumberRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
